...
import { createCreateManyMutationFn, createCreateManySuccessHandler } from '@ginjou/core'
import type { BaseRecord, CreateManyMutateFn, CreateManyMutationProps, CreateManyResult, Fetchers } from '@ginjou/core'
