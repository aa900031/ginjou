...
import type { BaseRecord, CreateMutateFn, CreateMutationProps, CreateResult, Fetchers } from '@ginjou/core'
import { createCreateMutationFn, createCreateSuccessHandler } from '@ginjou/core'
