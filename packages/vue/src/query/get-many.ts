...
import type { BaseRecord, Fetchers, GetManyQueryProps, GetManyResult, Meta, RecordKey } from '@ginjou/core'
import { createGetManyPlacholerDataFn, createGetManyQueryFn, genGetManyQueryKey } from '@ginjou/core'
