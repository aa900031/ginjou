...
import defineController from '~/ginjou/controller'
...
| `useAsyncGetManyByOne` | `useGetManyByOne` | SSR-friendly per-id multi-record queries |
...
| Group | Auto imports |
| --- | --- |
| App contexts | `useFetchersContext`, `useQueryClientContext`, `useAuthContext`, `useAuthzContext`, `useNotificationContext`, `useRealtimeContext`, `useControllerContext` |
| Data hooks | `useGetOne`, `useGetMany`, `useGetManyByOne`, `useGetList`, `useGetInfiniteList`, `useCreateOne`, `useCreateMany`, `useUpdateOne`, `useUpdateMany`, `useDeleteOne`, `useDeleteMany`, `useCustom`, `useCustomMutation` |
...
| Group | Auto imports |
| --- | --- |
| Async data hooks | `useAsyncGetOne`, `useAsyncGetMany`, `useAsyncGetManyByOne`, `useAsyncGetList`, `useAsyncGetInfiniteList` |
