...
| Data hooks | `useGetOne`, `useGetMany`, `useGetManyByOne`, `useGetList`, `useGetInfiniteList`, `useCreateOne`, `useCreateMany`, `useUpdateOne`, `useUpdateMany`, `useDeleteOne`, `useDeleteMany`, `useCustom`, `useCustomMutation`, `useQueryInvalidate` |
