...
Ginjou requires [@tanstack/vue-query](https://www.npmjs.com/package/@tanstack/vue-query) to manage data fetching, caching, and synchronization.
...
Here is a example of a root component (`App.vue`) configured with common providers and integrations.
