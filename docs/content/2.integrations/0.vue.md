...
This design keeps each integration explicit. You can register only the capabilities you need today, then add auth, notifications, realtime, or i18n later without rewriting the whole setup.
...
::tip
Use the root component for provider registration, not feature-level components. Context registration is part of application wiring, not page logic.
::
