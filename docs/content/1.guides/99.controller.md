...
Controller context is the shared model behind route-aware controllers and resource path helpers.
...
Controller context is the registry of resource definitions for your app.
...
import { defineController } from '@ginjou/core'
import { defineControllerContext } from '@ginjou/vue'

defineControllerContext(defineController({
	resources: [
		{
			name: 'posts',
			list: '/posts',
...
```ts
import { defineController, ResourceAction } from '@ginjou/core'
