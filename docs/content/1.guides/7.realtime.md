...
`@ginjou/with-supabase` ships a ready-made realtime provider. See the [Supabase](/backend/supabase#realtime) page. This page focuses on the contract and how it connects to the data layer.
