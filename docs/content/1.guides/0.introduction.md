...
Read Guides for core patterns, Integrations for Vue and Nuxt setup, and Backends for provider-specific behavior.
...
to: /backend/directus
---
`@ginjou/with-directus` Directus fetcher and auth bridges.
::
...
to: /backend/supabase
---
`@ginjou/with-supabase` Supabase fetcher and auth bridges.
::
