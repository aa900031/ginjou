...
Use this reference for non-page reads and writes in Vue. See [Data](https://ginjou.pages.dev/raw/guides/data.md) for workflow guidance. See [behavior.md](./behavior.md) for non-page boundaries, invalidation, and mutation-mode safety.
