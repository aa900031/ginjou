...
behavior match Vue** — read [vue.md](./vue.md) for the
API and [behavior.md](./behavior.md) for state/filter/sorter
rules. This file pins only the Svelte syntax. See [setup/svelte.md](../setup/svelte.md)
