...
Use page controllers for standard CRUD pages, and use [data-flow.md](./data-flow.md) for dialogs, row actions, widgets, side panels, and other custom orchestration surfaces.

Create and edit mutation timing plus redirect behavior are detailed in [mutation-flows.md](./mutation-flows.md).
...
- Drop to [data-flow.md](./data-flow.md) when the UI is not a standard page surface.
