...
Use this reference for Vue notification wiring and manual notification helpers. See [Notifications](https://ginjou.pages.dev/raw/guides/notifications.md) for workflow guidance and built-in notify behavior.
