...
Use this reference for Vue 3 root wiring. See [Vue](https://ginjou.pages.dev/raw/integrations/vue.md) for the full setup walkthrough. See [behavior.md](./behavior.md) for provider-model, optional-capability, and multi-backend rules.
