...
Vue** — read [vue/data-composables.md](../vue/data-composables.md) for the full
table (which composable for what, batch variants, custom flows) and
[core/data-flow.md](../core/data-flow.md) for boundaries. This file pins only the
Svelte syntax. See [svelte/setup.md](./setup.md) for runes/accessor conventions.
