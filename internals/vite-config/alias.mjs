...
export default {
	...
	'@ginjou/with-svelte-spa-router': fileURLToPath(new URL('../../packages/with-svelte-spa-router/src', import.meta.url)),
	...
	'@ginjou/with-directus': fileURLToPath(new URL('../../packages/with-directus/src', import.meta.url)),
